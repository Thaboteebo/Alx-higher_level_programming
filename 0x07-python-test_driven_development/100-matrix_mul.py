#!/usr/bin/python3
"""Module for matrix_mul medoth."""


def matrix_mul(m_a, m_b):
    """Multiples one matrix by another.
    Args:
    ...
    Raises:
        ...
        ValueError: If m_a or m_b can't br mutliplied.
    """
    ...
    if len(m_b[0]) != len(m_b):
        raise ValueError("m_a and m_b can't be mutliplied")
